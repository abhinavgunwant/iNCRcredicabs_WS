...
public class RosterModel {
	...
	public String getMax_route() {
		return max_route;
	}

	public void setMax_route(String max_route) {
	...
	public String getGuard_required() {
		return guard_required;
	}

	public void setGuard_required(String guard_required) {
		this.guard_required = guard_required;
	}
