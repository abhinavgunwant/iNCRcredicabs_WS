...
public class ReportServiceImpl {
	...
	public JSONArray vendorDetailed() throws SQLException
    {
           ...
           DBConnectionRo dbconnectionro=new DBConnectionRo();
           Connection connection=dbconnectionro.getConnection();
           PreparedStatement ps=(PreparedStatement) connection.prepareStatement("SELECT R.vendor_name AS Vendor_Name,N.Emp_Qlid AS Emp_Qlid,S.Emp_FName AS Emp_FName,R.Cab_Cost AS Cab_Cost,R.Start_Date AS DATE,R.Cab_No AS Cab_No,N.Source AS Source,N.Destination AS Destination,N.Other_Addr AS Other_Addr,S.Emp_Zone AS Emp_Zone\n" + 
                        "FROM  ankur_unscheduled_rqst_tbl N INNER JOIN ankur_ncab_roster_tbl R,ankur_ncab_master_employee_tbl AS S \n" + 
	...
	public JSONArray vendorSummary() throws SQLException
    {
           ...
           DBConnectionRo dbconnectionro=new DBConnectionRo();
           Connection connection=dbconnectionro.getConnection();
           PreparedStatement ps=(PreparedStatement) connection.prepareStatement("SELECT a.vendor_name AS Vendor_Name,SUM(a.Cab_Cost) AS Cab_Cost,COUNT(DISTINCT(a.Cab_No)) AS Cab_Count FROM ankur_ncab_roster_tbl AS a WHERE a.Shift_Id=4  GROUP BY a.Vendor_name;");
           ResultSet rs=ps.executeQuery();
           while(rs.next())
           {
                  JSONObject jsonresponse=new JSONObject();
	...
	public JSONArray employeeDetailed() throws SQLException
    {
           ...
           DBConnectionRo dbconnection=new DBConnectionRo();
           Connection connection=dbconnection.getConnection();
           PreparedStatement ps=(PreparedStatement) connection.prepareStatement("Select b.Emp_Qlid AS Emp_Qlid,a.vendor_name As Vendor_Name,c.Emp_FName AS Emp_FName,c.Emp_Mgr_Qlid1 AS Emp_Mgr_Qlid1 ,a.Start_Date AS Start_Date_Time,a.Cab_Cost AS Cab_Cost,a.Cab_No AS Cab_No,d.model As Cab_Type,\n" + 
                        "b.Source,b.Destination,b.Other_addr AS TripType,c.Emp_Zone AS Zone \n" + 
                        "from ankur_ncab_roster_tbl  a,ankur_unscheduled_rqst_tbl  b ,ankur_ncab_master_employee_tbl c ,ncab_cab_master_tbl d\n" + 
	...
	public JSONArray employeeDetailed(JSONObject jsonrequest) throws SQLException, ParseException
    {
           ...
           ps=(PreparedStatement)connection.prepareStatement("Select b.Emp_Qlid AS Emp_Qlid,a.vendor_name,c.Emp_FName AS Emp_FName,c.Emp_Mgr_Qlid1 AS Emp_Mgr_Qlid1 ,a.Start_Date AS Start_Date_Time,a.Cab_Cost AS Cab_Cost,a.Cab_No AS Cab_No,d.model,\n" + 
                        "b.Source,b.Destination,b.Other_addr AS TripType,c.Emp_Zone AS Zone \n" + 
                        "from ankur_ncab_roster_tbl a,ankur_unscheduled_rqst_tbl  b ,ankur_ncab_master_employee_tbl c ,ncab_cab_master_tbl d\n" + 
                        "where b.Shift_ID=a.Shift_Id AND b.Emp_Qlid=c.Emp_Qlid AND a.Emp_Qlid=b.Emp_Qlid AND d.cab_license_plate_no=a.Cab_No\n" + 
	...
	public JSONArray employeeSummary(JSONObject jsonrequest) throws SQLException
    {
           ...
           String toDate= jsonrequest.getString("toDate");
           String fromDate= jsonrequest.getString("fromDate");
           ps=(PreparedStatement)connection.prepareStatement("Select  f.Emp_Qlid As Emp_Qlid,f.Emp_FName As Emp_FName,f.Emp_Mgr_Qlid1 As Emp_Mgr_Qlid1,concat(b.Emp_FName,' ',b.Emp_LName) As ManagerName,f.No_cab As Cab_Count,f.Cost As cab_Cost \n" + 
                        "from employee_summary AS f,ankur_ncab_master_employee_tbl AS b \n" + 
           ...
           while(rs.next())
           {
                  ...
                  jsonresponse.put("Emp_FName", rs.getString(2));
                  jsonresponse.put("Emp_Mgr_Qlid1", rs.getString(3));
                  jsonresponse.put("ManagerName", rs.getString(4));
	...
	public JSONArray vendorSummary(JSONObject jsonrequest) throws SQLException
    {
           ...
           PreparedStatement ps=null;
                  ...
                  ps=(PreparedStatement)connection.prepareStatement("Select a.vendor_name As Vendor_Name,Sum(a.Cab_Cost) As Cab_Cost,Count(distinct(a.Cab_No)) As Cab_Count \n" + 
                               "from ankur_ncab_roster_tbl AS a\n" + 
	...
	public JSONArray vendorDetailed(JSONObject jsonrequest) throws SQLException
    {
           ...
           String fromDate=jsonrequest.getString("fromDate");
           PreparedStatement ps=null;
           ps=(PreparedStatement)connection.prepareStatement("SELECT R.vendor_name AS Vendor_Name,N.Emp_Qlid AS Emp_Qlid,S.Emp_FName AS Emp_FName,R.Cab_Cost AS Cab_Cost,R.Start_Date AS DATE,R.Cab_No AS Cab_No,N.Source AS Source,N.Destination AS Destination,N.Other_Addr AS Other_Addr,S.Emp_Zone AS Emp_Zone\n" + 
                        "FROM  ankur_unscheduled_rqst_tbl N INNER JOIN ankur_ncab_roster_tbl R,ankur_ncab_master_employee_tbl AS S \n" + 
                        "WHERE N.Emp_Qlid=R.Emp_Qlid  AND N.Emp_Qlid=S.Emp_Qlid \n" + 
 ...
 public JSONArray managerDetailed() throws SQLException
	{
		...
		DBConnectionRo dbconnectionro=new DBConnectionRo();
		Connection connection=dbconnectionro.getConnection();
		PreparedStatement ps=(PreparedStatement) connection.prepareStatement("SELECT CONCAT(a.Emp_FName,a.Emp_LName) AS Employee_Name,b.Emp_Qlid AS Emp_Qlid,b.Rqst_Date_Time AS Rqst_Date_Time,c.Vendor_Name AS Vendor_Name,c.Drop_type AS Trip_Type,\n" + 
				"b.Source AS Source,b.Destination AS Destination,a.Emp_Zone AS Emp_Zone,c.Cab_Cost AS Cab_Cost FROM ankur_unscheduled_rqst_tbl b \n" + 
				"INNER JOIN ankur_ncab_master_employee_tbl a ON b.Emp_Qlid=a.Emp_Qlid INNER JOIN ankur_ncab_roster_tbl c ON b.Emp_Qlid=c.Emp_Qlid    \n" + 
				";");
		ResultSet rs=ps.executeQuery();
...
//vendor cost
        ...
        connection=dbconnection.getConnection();        
                                ...
                                JSONObject jsonobj=new JSONObject();                                                if(rs.getString(3).equalsIgnoreCase("3") && rs.getString(4).equals("2018")) {
                                       ...
                                       // jsonresponse.put("Roster_Month",rs.getString(3));
                                       // jsonresponse.put("Roster_Year",rs.getString(4));
...
//                                                                                                            total_no_regular_cab_big=sumcab;
                                                ...
                                                //if(Integer.parseInt((String) jsonobjfinal.get("total_no_regular_cab_big")))
...
//jsonobjfinal.remove("total_no_of_regular_employees_big");
                                ...
                                jsonobjt.put("other", jsonobjfinalnew);
                                jsonobjt.put("vendor", jsonarray0);
                                jsonarray.put(jsonobjt);
